...
string, a `\Elite\Permission\Models\Role` object or an `\Illuminate\Support\Collection` object.
...
string or a `Elite\Permission\Models\Permission` object.
...
All these responses are collections of `Elite\Permission\Models\Permission` objects.
